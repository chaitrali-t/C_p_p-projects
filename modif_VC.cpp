...
int mass(string ip_unit, string op_unit, double ip_value) {
    double temp_value{0};
    double op_value{0};
...
int lenght(string ip_unit, string op_unit, double ip_value) {
    double temp_value{0};
    double op_value{0};
...
int temperarure (string ip_unit, string op_unit, double ip_value) {
    double temp_value{0};
    double op_value{0};
    // Input value and its units are taken.
    cout << "\tCelsius(c)\n\tFahrenheit(f)\n\tKelvin(k)\n\t" << endl;
