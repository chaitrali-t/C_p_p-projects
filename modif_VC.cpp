...
int length(double ip_value, string ip_unit, string op_unit) {
    double temp_value{0};
    double op_value{0};
...
int temperature (double ip_value, string ip_unit, string op_unit) {
    double temp_value{0};
    double op_value{0};
    // Converting the input value into a standard value for easier calculation.
    // Here it is Celsius.
    ...
    while (option != 4) {
        ...
        if (option == 1) {
            ...
            if (ip_value < 0) {
                ...
                cout << "Enter the desired unit: ";
                cin >> op_unit;
                length(ip_value, ip_unit, op_unit);
            }
        }
        else if (option == 3) {
            // Input value and its units are taken.
            ...
            cout << "Enter the desired unit: ";
            cin >> op_unit;
            temperature(ip_value, ip_unit, op_unit);
        }
        else {
